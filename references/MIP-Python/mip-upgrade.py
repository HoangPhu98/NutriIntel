...
def solveModelMin(food, conditionNutri):
    ...
    #Variables
    weight = [solver.NumVar(0.5, solver.infinity(), 'w-' + food[i][0]) for i in range(nbFood)]
...
"""
# Check enough nutrient in food  
# return nutrient hasn't enough or enough 
"""
